...
public class Board {
	...
	static {
		...
		PROPS[29] = new Property("MarvinGardens", 280, 150, new int[] { 24, 120, 360, 850, 1025, 1200 }, 140,
				"property");
		// Green
		PROPS[31] = new Property("Pacific", 300, 200, new int[] { 26, 130, 390, 900, 1100, 1275 }, 150, "property");
		PROPS[32] = new Property("NorthCarolina", 300, 200, new int[] { 26, 130, 390, 900, 1100, 1275 }, 150,
				"property");
		PROPS[34] = new Property("Pennsylvania", 320, 200, new int[] { 28, 150, 450, 1000, 1200, 1400 }, 160,
				"property");
		// Dark Blue
