...
public class MapManager {
	...
	/**
	 * Render a 10×4 ring with fixed slots and player initials. LABELS array used
	 * for concise display.
	 */
	public void render(Participant[] players) {
		String[] LABELS = { "GO", "ME", "CC", "BA", "IT", "RR", "OR", "CH", "VE", "CO", "JV", "SC", "EC", "ST", "VI",
				"RR", "SJ", "CC", "TE", "NY", "FP", "KY", "CH", "IN", "IL", "RR", "AT", "WW", "MG", "GJ", "GJ", "PA",
				"NC", "CC", "PR", "SL", "CH", "PP", "LT", "BW" };
